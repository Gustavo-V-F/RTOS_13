...
osSemaphoreId xBinary_semaphore_handle;
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* definition and creation of xBinary_semaphore */
  osSemaphoreDef(xBinary_semaphore);
  xBinary_semaphore_handle = osSemaphoreCreate(osSemaphore(xBinary_semaphore), 1);
